...
import org.isoron.ADAY.acceptance.steps.CommonSteps.verifyOpensWebsite
import org.isoron.ADAY.acceptance.steps.ListHabitsSteps.MenuItem.ABOUT
import org.isoron.ADAY.acceptance.steps.ListHabitsSteps.MenuItem.HELP
...
class LinksTest : BaseUserInterfaceTest() {
    ...
    fun shouldLinkToTranslationWebsite() {
        ...
        verifyOpensWebsite("translate.ADAYhabits.org")
    }
