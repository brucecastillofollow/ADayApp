 ...
 */
package org.isoron.ADAY.utils

import android.content.Context
import android.database.sqlite.SQLiteDatabase
import android.util.Log
import androidx.documentfile.provider.DocumentFile
import org.isoron.ADAY.HabitsApplication.Companion.isTestMode
import org.isoron.ADAY.HabitsDatabaseOpener
import org.isoron.ADAY.core.DATABASE_FILENAME
import org.isoron.ADAY.core.DATABASE_VERSION
import org.isoron.ADAY.core.utils.DateFormats.Companion.getBackupDateFormat
import org.isoron.ADAY.core.utils.DateUtils.Companion.getLocalTime
import java.io.File
...
object DatabaseUtils {
    ...
    fun saveDatabaseCopy(context: Context, dir: File): String {
        ...
        val filename = "${dir.absolutePath}/ADAY Habits Backup $date.db"
    ...
    fun saveDatabaseCopy(context: Context, dir: DocumentFile): String {
        val dateFormat: SimpleDateFormat = getBackupDateFormat()
        val date = dateFormat.format(getLocalTime())
        val file = dir.createFile("application/octet-stream", "ADAY Habits Backup $date.db")
