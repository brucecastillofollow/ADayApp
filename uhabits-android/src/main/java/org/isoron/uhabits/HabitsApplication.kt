...
import org.isoron.ADAY.core.database.UnsupportedDatabaseVersionException
...
import org.isoron.ADAY.inject.DaggerHabitsApplicationComponent
...
/**
 * The Android application for ADAY Habit Tracker.
 */
class HabitsApplication : Application() {
    ...
    companion object {
        ...
        fun isTestMode(): Boolean {
            return try {
                Class.forName("org.isoron.ADAY.BaseAndroidTest")
                true
