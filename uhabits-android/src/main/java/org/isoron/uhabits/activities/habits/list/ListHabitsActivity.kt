...
import org.isoron.ADAY.BaseExceptionHandler
...
import org.isoron.ADAY.core.ui.ThemeSwitcher.Companion.THEME_DARK
import org.isoron.ADAY.core.utils.MidnightTimer
import org.isoron.ADAY.database.AutoBackup
import org.isoron.ADAY.inject.ActivityContextModule
import org.isoron.ADAY.inject.DaggerHabitsActivityComponent
import org.isoron.ADAY.inject.HabitsActivityComponent
...
class ListHabitsActivity : AppCompatActivity(), Preferences.Listener {
        ...
        if (appComponent.reminderScheduler.hasHabitsWithReminders()) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
                ...
                if (checkSelfPermission(this, POST_NOTIFICATIONS) == PERMISSION_GRANTED) {
                    ...
                    // nothing. This check is necessary to avoid an infinite onResume ADAY in case
    ...
    companion object {
        const val ACTION_EDIT = "org.isoron.ADAY.ACTION_EDIT"
    }
}
