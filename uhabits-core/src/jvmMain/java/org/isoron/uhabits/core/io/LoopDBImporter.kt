...
import org.isoron.ADAY.core.database.MigrationHelper
...
import org.isoron.ADAY.core.utils.isSQLite3File
import java.io.File
import javax.inject.Inject

/**
 * Class that imports data from database files exported by ADAY Habit Tracker.
 */
class ADAYDBImporter
@Inject constructor(
    ...
    private val logger = logging.getLogger("ADAYDBImporter")
